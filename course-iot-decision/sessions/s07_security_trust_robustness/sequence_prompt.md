...
**Séquence à préparer : Confiance, sécurité et robustesse de la chaîne**

Objectif général de la séquence :

Relier sécurité, intégrité des données et qualité de décision.
...
Question décisionnelle : Que vaut une décision opérationnelle si l'on ne peut pas qualifier la confiance dans la chaîne de données ?
