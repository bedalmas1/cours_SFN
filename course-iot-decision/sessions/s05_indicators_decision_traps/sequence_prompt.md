...
**Séquence à préparer : Indicateurs, agrégations et pièges décisionnels**

Objectif général de la séquence :

Montrer qu'un indicateur, qu'il soit un simple calcul statistique ou un score produit par un modèle automatique, compresse toujours la réalité et peut masquer un risque ; plus ce calcul devient opaque, plus cette compression doit être interrogée avant d'être suivie.
