...
**Séquence à préparer : Qualité des données et incertitude**

Objectif général de la séquence :

Comprendre que la qualité des données conditionne directement le niveau de confiance dans la décision.
